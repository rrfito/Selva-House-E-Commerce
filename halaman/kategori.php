...
<body class="g-sidenav-show   bg-gradient-warning">
            ...
            <div class="card-body ">
                <div class="table-responsive">
                    <table id="example" class="table table-hover">
                        ...
                        <td>
        <button type='button' class='btn btn-primary' onclick='openUpdateModal(" . $row['cat_id'] . ", \"" . $row['nama_kategori'] . "\")'>Update</button>
        <a href='../Controller/kategoriDB.php?action=delete&id=" . $row['cat_id'] . "' class='btn btn-danger'>Delete</a>
    </td>
                        </tr>";
                            }
                            ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="formTambahData" action="../Controller/kategoriDB.php" method="POST"
                    ...
                    <div class="modal fade" id="updateModal" tabindex="-1" aria-labelledby="updateModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="formUpdateData" action="../Controller/kategoriDB.php" method="POST"
                                        enctype="multipart/form-data">
                                        <div class="mb-3">
                                            <label for="update_nama_kategori" class="form-label">Nama Kategori</label>
                                            <input type="text" class="form-control" id="update_nama_kategori"
                                                name="update_nama_kategori" required>
                                        </div>
    ...
    <script>
        ...
        function openUpdateModal(cat_id, nama_kategori) {
        $('#update_cat_id').val(cat_id);
        $('#update_nama_kategori').val(nama_kategori);
